                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="display_books.php"><i class="fa fa-edit"></i>All Books Info <span class="fa fa-chevron-down"></span></a>

                            </li>
                             <li><a href="books_details_with_student.php"><i class="fa fa-edit"></i>Books with All Info <span class="fa fa-chevron-down"></span></a>
