                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                               ...
                               while($row=mysqli_fetch_array($res))
                               {
                                ...
                                echo "<br>";
                                echo "<b>"."Name:".$row["books_name"]."</b>";
                                echo "<br>";
                                echo "<b>"."Total Books".$row["books_qty"]."</b>";
                                echo "<br>";
                                echo "<b>"."available:".$row["available_qty"]."</b>";
                                echo "<br>";
                                ?> <a href="all_student_of_this_books.php?books_name=<?php echo $row["books_name"]; ?>" style="color:seagreen;">Student Record if this books</a><?php
                                echo "</td>";
                                if ($i==2) {
                                    echo "</tr>";
                                    echo "<tr>";
