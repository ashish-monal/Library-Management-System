                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="message_from_librarain.php"><i class="fa fa-mail-forward"></i> Message from Librarain <span
                ...
                <nav>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li role="presentation" class="dropdown">
                            <a href="message_from_librarain.php" class="dropdown-toggle info-number" data-toggle="dropdown"
                               aria-expanded="false">
                                <i class="fa fa-envelope-o"></i>
                                <span class="badge bg-green" onclick="window.location='message_from_librarain.php';"><?php echo $tot; ?></span>
                            </a>
